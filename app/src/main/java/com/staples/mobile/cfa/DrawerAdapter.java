...
public class DrawerAdapter extends BaseAdapter {
    ...
    public void fill() {
        ...
        array.add(new DrawerItem(activity, R.drawable.ic_weekly_ad_black, R.string.weekly_ad_title, WeeklyAdByCategoryFragment.class));
        array.add(new DrawerItem(activity, R.drawable.ic_account_black, R.string.account_title, ProfileFragment.class, false));
        array.add(new DrawerItem(activity, R.drawable.ic_rewards_black, R.string.rewards_title, RewardsFragment.class, false)); // set initially disabled
        array.add(new DrawerItem(activity, R.drawable.ic_orders_black, R.string.order_title, OrderFragment.class, false)); // set initially disabled
        array.add(new DrawerItem(activity, R.drawable.ic_profile_black, R.string.profile_title, ProfileFragment.class, false)); // set initially disabled
        array.add(new DrawerItem(activity, R.drawable.ic_notifications_black, R.string.notify_prefs_title, NotifyPrefsFragment.class));
        array.add(new DrawerItem(activity, R.drawable.ic_info_black, R.string.terms_title, TermsFragment.class));
        array.add(new DrawerItem(activity, R.drawable.ic_info_black, R.string.about_title, AboutFragment.class));
    }
}
