package com.staples.mobile.cfa.apptentive;
...
public class ApptentiveSdk {
    ...
    public static final String HOME_CONTAINER_SHOWN_EVENT = "home_container_shown";
    ...
    public static final String SEARCH_SHOWN_EVENT = "search_shown";
